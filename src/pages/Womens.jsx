...
const categories = [
  {
    image: `${import.meta.env.VITE_BACKEND_URL}/categoryw5.png`,
    title: "Clothing",
    description: "Hoodies, tees, jackets, shorts and more...",
    link: "clothing",
  },
  {
    image: `${import.meta.env.VITE_BACKEND_URL}/categoryw2.png`,
    title: "Jackets",
    description: "Stay warm with a huge range of fleeces, jackets & coats",
    link: "jackets",
  },
  {
    image: `${import.meta.env.VITE_BACKEND_URL}/categoryw1.png`,
    title: "Shoes",
    description: "Vans, New Balance, Dr Marten's, Birkenstock & more!",
    link: "footwear",
  },
  {
    image: `${import.meta.env.VITE_BACKEND_URL}/categoryw3.png`,
    title: "Accessories",
    description: "The finishing touches of all the accessories",
    link: "accessories",
  },
  {
    image: `${import.meta.env.VITE_BACKEND_URL}/categoryw4.png`,
    title: "Jeans",
...
function Womens() {
  return (
    <>
      <Banner
        imageUrl={`${import.meta.env.VITE_BACKEND_URL}/womenbanner.jpg`}
        title="womens"
      />
